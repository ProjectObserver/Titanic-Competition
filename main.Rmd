...
m<-lm(Age~title:SibSp+ title:Pclass+ title:Parch + title:Fare:Pclass, data=ds)
summary(m)
...
tgbm = train(Survived ~ Sex + AgeDecile:Pclass + SibSp, data=ds, method="gbm", metric="Kappa", trControl=ctrl, subset = in_train, verbose=FALSE)
trf = train(Survived ~ Sex + AgeDecile:Pclass  + SibSp, data=ds, method="rf", metric="Kappa", trControl=ctrl, subset = in_train, verbose=FALSE)
